...
#         'resetKeyboard': True
#     }
#     driver = webdriver.Remote("http://127.0.0.1:" +
#                               str(4723) + "/wd/hub", capabilities)
...
#         "org.cnodejs.android.md:id/tv_login_name").click()
#     time.sleep(5)
#     driver.find_element_by_id(
#         "org.cnodejs.android.md:id/edt_access_token").send_keys("fgdgdfsgsdf")
